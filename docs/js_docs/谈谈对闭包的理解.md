...
[![Bz6jVe.png](https://s3.ax1x.com/2020/11/12/Bz6jVe.png)](https://imgchr.com/i/Bz6jVe)
...
[![BzcrZD.png](https://s3.ax1x.com/2020/11/12/BzcrZD.png)](https://imgchr.com/i/BzcrZD)
...
[![BzgPY9.png](https://s3.ax1x.com/2020/11/12/BzgPY9.png)](https://imgchr.com/i/BzgPY9)

反之，就是内存泄漏了。
[![BzgMYd.png](https://s3.ax1x.com/2020/11/12/BzgMYd.png)](https://imgchr.com/i/BzgMYd)
...
process.memoryUsage返回一个对象，包含了 Node 进程的内存占用信息。该对象包含四个字段，单位是字节，含义如下。
 ...
 [![Bzg4pR.png](https://s3.ax1x.com/2020/11/12/Bzg4pR.png)](https://imgchr.com/i/Bzg4pR)
