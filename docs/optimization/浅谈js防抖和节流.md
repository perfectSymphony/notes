...
运行以上代码的结果是：
 ...
 上述内容基于防抖和节流的核心思路设计了简单的实现算法，但是不代表实际的库（例如undercore js）的源码就直接是这样的。本文依然坚持突出核心代码，尽可能剥离无关功能点的思路行文因此不做赘述。

 # 结合参看 [https://www.cnblogs.com/goloving/p/8672361.html](https://www.cnblogs.com/goloving/p/8672361.html)