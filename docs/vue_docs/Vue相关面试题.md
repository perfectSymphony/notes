...
2. MVC的定义：
1⃣️ MVC是Model-View- Controller的简写。即模型-视图-控制器。
 ...
 3⃣️. MVVM框架:VUE的介绍Vue就是基于MVVM模式实现的一套框架，
 ...
 ![d4c3od.jpg](https://s1.ax1x.com/2020/08/27/d4c3od.jpg)
